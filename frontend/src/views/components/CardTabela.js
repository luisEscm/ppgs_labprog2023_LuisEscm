...
function CardTabela({categorias, tabela, paginaSite, titulo, carregando}, ref) {
    ...
    <div className="col-md">
        ...
        <div className="card-body">
            ...
            <table className="table table-striped table-hover">
                ...
                <tbody>
                    {!carregando && tabela.slice(base, fim) }
                </tbody>
                {carregando && <Loading />}
            </table>
...
export default forwardRef(CardTabela);
